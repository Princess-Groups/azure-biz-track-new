...
import { EditAccountDialog, DeleteAccountDialog } from "@/components/EditAccountDialog";
import { fetchAccounts, fetchIncome, fetchExpenses, type Account } from "@/lib/db";
import { supabase } from "@/integrations/supabase/client";
import { inr } from "@/lib/format";
import { useAuth } from "@/hooks/useAuth";
import { useMemo, useState } from "react";
import { toast } from "sonner";
import { Plus, Wallet, CalendarRange, TrendingUp, TrendingDown, PiggyBank, Pencil, Trash2 } from "lucide-react";
              ...
              {isAdmin && (
                <div className="mt-3 grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-rose-200 bg-rose-50/70 px-3 py-2 text-xs font-semibold text-rose-700 hover:bg-rose-100"
                  >
